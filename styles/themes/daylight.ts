...
const colors = {
  ...
  info: "#4D9FFF",
  logoFill: "#1D1010",
  logoPrimaryColor: "#D4A574", // Amber - distinct from surface, matches accent
  logoSecondaryColor: "#8B6F6F", // Muted plum - complements amber, distinct from border
